...
public class InterConstantPropagation extends
    ...
    protected CPFact transferCallToReturnEdge(CallToReturnEdge<Stmt> edge, CPFact out) {
        ...
        if (edge.getSource() instanceof DefinitionStmt definitionStmt && definitionStmt.getLValue() instanceof Var var) {
            outCopy.update(var, Value.getUndef());
        }
        return outCopy;
    }
    ...
    protected CPFact transferCallEdge(CallEdge<Stmt> edge, CPFact callSiteOut) {
        ...
        for (int i = 0; i < callee.getParamCount(); i++) {
            ...
            fact.update(param, callSiteOut.get(arg));
        }
        return fact;
    }
